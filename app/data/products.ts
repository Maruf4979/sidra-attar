...
export const products: Product[] = [
  ...
  {
    id: "45",
    slug: "quran-majeed-premium",
    name: "Quran Majeed (Premium Edition)",
    price: 1299,
    category: "Islamic Books",
    tags: ["Quran", "Premium", "Ornate"],
    description: "A majestic edition of the Holy Quran with a luxurious velvet cover and gold-embossed calligraphy.",
    story: "This premium edition of the Quran Majeed is crafted for those who cherish fine craftsmanship. Featuring high-opacity cream paper and clear Indo-Pak script, it is housed in a beautiful protective velvet cover.",
    profile: {
      type: "Book",
      material: "Premium Paper & Velvet",
      size: "A5",
      occasion: "Gift & Daily Recitation",
    },
    occasions: ["Daily", "Ramadan", "Gifting"],
    gradient: "linear-gradient(145deg, #1a3a20 0%, #2a5a38 50%, #0d2012 100%)",
    accent: "#5cb87a",
    image: "/books/quran-premium.png",
  },
  {
    id: "46",
    ...
    price: 4500,
    category: "Islamic Books",
    tags: ["Hadith", "Sunnah", "Essential"],
    description: "The most authentic collection of Hadith, beautifully bound in classic leather-style covers.",
    story: "Sahih al-Bukhari is the most authoritative collection of the sayings and deeds of Prophet Muhammad (PBUH). This complete set is an essential reference for every Muslim household.",
    profile: {
      type: "Book Set",
      material: "Hardcover Leather-style",
      size: "Standard",
      occasion: "Study & Reference",
    },
    occasions: ["Study", "Reference", "Gifting"],
    gradient: "linear-gradient(145deg, #2c1810 0%, #4a2c20 50%, #1a0f0a 100%)",
    accent: "#C5A059",
    image: "/books/sahih-bukhari.png",
  },
  {
    id: "47",
    slug: "tafseer-ibn-kathir",
    name: "Tafseer Ibn Kathir (Condensed)",
    price: 2800,
    category: "Islamic Books",
    tags: ["Tafseer", "Quran Study", "Scholarly"],
    description: "The renowned Quranic commentary by Imam Ibn Kathir, simplified for the modern reader.",
    story: "One of the most popular and widely accepted explanations of the Quran. This version provides the essence of the original multi-volume work in a more accessible format without losing depth.",
    profile: {
      type: "Book",
      material: "Hardcover",
      size: "Large",
    ...
    occasions: ["Study", "Ramadan", "Gifting"],
    gradient: "linear-gradient(145deg, #0a2a3a 0%, #1a4a6e 50%, #061a24 100%)",
    accent: "#70c8e8",
    image: "/books/tafseer-ibn-kathir.png",
  },
  {
    id: "48",
    slug: "the-noble-quran-translation",
    name: "The Noble Quran (English Translation)",
    price: 850,
    category: "Islamic Books",
    tags: ["Translation", "English", "Modern"],
    description: "A clear and contemporary English translation of the Holy Quran for easy understanding.",
    story: "This edition features the 'The Noble Quran' translation, known for its accuracy and flow. It includes brief footnotes to provide context, making it ideal for new Muslims and students of knowledge.",
    profile: {
      type: "Book",
      material: "Softcover Premium",
      size: "Medium",
      occasion: "Learning",
    },
    occasions: ["Daily", "Learning", "Travel"],
    gradient: "linear-gradient(145deg, #f0ece8 0%, #e0d8d0 50%, #d0c8b8 100%)",
    accent: "#8a7a68",
    image: "/books/quran-translation.png",
  },
  {
    id: "49",
    slug: "hisnul-muslim-pocket",
  ...
  {
    id: "50",
    slug: "discovery-set-deal",
    name: "Ultimate Discovery Set",
    price: 999,
    originalPrice: 1999,
    ...
    occasions: ["Discovery", "Travel", "Gifting"],
    gradient: "linear-gradient(145deg, #1a1a1a 0%, #333333 50%, #0a0a0a 100%)",
    accent: "#ff3e3e",
    badge: "50% OFF",
    image: "/gift-set.png",
  },
  {
    id: "51",
    slug: "oud-royale-edp",
    name: "Oud Royale EDP - Limited Edition",
    price: 4999,
    originalPrice: 6500,
    category: "Luxury Perfumes",
    tags: ["Luxury", "Oud", "Intense"],
    description: "A masterpiece of Arabian perfumery, blending rare Cambodian Oud with Bulgarian Rose.",
    story: "Oud Royale is the jewel of our collection. Aged for 12 months, this fragrance captures the essence of royalty. It is bold, commanding, and infinitely complex—designed for those who appreciate the finer things in life.",
    profile: {
      longevity: "18h+",
      sillage: "Strong",
      gender: "Unisex",
  ...
  {
    id: "52",
    slug: "ramadan-luxury-hamper",
    name: "Ramadan Signature Hamper",
    price: 5500,
    category: "Gifts",
    tags: ["Hamper", "Ramadan", "Premium"],
    description: "A curated collection of spiritual essentials for the holy month.",
    story: "This signature hamper includes a premium prayer mat, 3 signature attars, a box of Medjool dates, and a crystal tasbih. It is the perfect way to share blessings with your loved ones.",
    profile: {
      type: "Gift Hamper",
      material: "Wooden Basket",
      occasion: "Ramadan & Eid",
    },
    occasions: ["Ramadan", "Eid", "Gifting"],
    gradient: "linear-gradient(145deg, #0e3a1a 0%, #1a5a2a 50%, #082a10 100%)",
    accent: "#80d890",
    image: "/luxury-hamper.png",
  },
  {
    id: "53",
    slug: "bridal-trousseau-box",
    name: "Nikah Bridal Trousseau Box",
    price: 8999,
    category: "Sadi Items (Nikah)",
    tags: ["Bridal", "Wedding", "Luxury"],
    description: "An opulent collection of fragrances and cosmetics for the modern bride.",
    story: "The Bridal Trousseau Box is a celebration of new beginnings. Featuring our most romantic attars, a luxury kajal, and a personalized message card, all housed in a handcrafted silk-lined trunk.",
    profile: {
      type: "Wedding Set",
      material: "Handcrafted Trunk",
      occasion: "Nikah",
    },
    occasions: ["Nikah", "Reception", "Wedding"],
    gradient: "linear-gradient(145deg, #5a1020 0%, #8a2040 50%, #3a0810 100%)",
    accent: "#f0c878",
    badge: "Exclusive",
    image: "/nikah-items.png",
  ...
  {
    id: "54",
    slug: "memory-foam-janamaz",
    name: "Orthopedic Memory Foam Janamaz",
    price: 2499,
    category: "Prayer Items (Namaz)",
    tags: ["Prayer Mat", "Comfort", "Memory Foam"],
    description: "A revolutionary prayer mat designed for maximum knee and joint support.",
    story: "Pray in complete comfort with our memory foam Janamaz. Specifically designed for those who experience discomfort during sujood, this mat provides deep cushioning while maintaining a stable surface for prayer.",
    profile: {
      type: "Prayer Mat",
      material: "Memory Foam, Velvet",
      size: "120 x 80 cm",
    },
    occasions: ["Daily Prayer", "Gifting Elders"],
    gradient: "linear-gradient(145deg, #0a3a20 0%, #1a5a38 50%, #062a15 100%)",
    accent: "#80d0a0",
    badge: "New Arrival",
    image: "/prayer-items.png",
